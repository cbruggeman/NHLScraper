...
# Convert time from string and period to seconds into game
...
#print parsePlayByPlay(urllib.urlopen("http://www.nhl.com/scores/htmlreports/20142015/PL021053.HTM").read())
